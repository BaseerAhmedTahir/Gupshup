...
-- Allow group creators to add members (based on groups table ownership)
...
-- Allow group creators to update member roles
...
-- Allow group admins to manage members (if they have admin role)
